...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      {/* UTILISATION DES CLASSES RESPONSIVE ICI (voir src/Responsive.css) */}
      <div className="dashboard-layout">
        ...
        <main className="dashboard-main">
          <h1 style={{marginBottom: '30px', color: '#2c3e50', fontSize: '1.8rem'}}>
          ...
          {activeTab === 'overview' && (
            <>
              {/* Ajout de la classe "stats-grid" pour le responsive mobile */}
...
// Styles CSS-in-JS (Les layouts sont maintenant gérés par les classes CSS dans Responsive.css)
const styles = {
  // layout, sidebar, main supprimés ici car déplacés dans Responsive.css
  ...
  // statsGrid gardé ici pour le desktop, mais surchargé par .stats-grid en mobile
  ...
  table: { width: '100%', borderCollapse: 'collapse', marginTop: '20px', minWidth: '500px' } // minWidth force le scroll
};
